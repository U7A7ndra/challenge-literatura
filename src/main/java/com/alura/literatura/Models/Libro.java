...
import com.alura.literatura.Dtos.GeneroLiteratura;
...
public class Libro {
    ...
    private GeneroLiteratura generoModificado(List<String> generos) {
        ...
        Optional<String> firstGenero = generos.stream()
                ...
                .findFirst();
        return firstGenero.map(GeneroLiteratura::fromString).orElse(GeneroLiteratura.DESCONOCIDO);
    }
